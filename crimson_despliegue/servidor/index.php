	...
	if(isset($_GET['o'])){
		switch($_GET['o']){
            ...
            case "eliminadocumento":
				 if (isset($_GET['coleccion']) && isset($_GET['id'])) {
					  echo $conexionmongo->eliminar($_GET['coleccion'], $_GET['id']); // Call the class method
				 } else {
					  echo json_encode(["error" => "Parámetros 'coleccion' e 'id' son requeridos."]);
				 }
				 break;    
            case "informe":
